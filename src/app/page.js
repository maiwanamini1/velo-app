...
export default function Home() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-white font-tt px-6">
      ...
      <div className="flex justify-center items-center gap-8 mt-20 mb-8">
        ...
        >
          <Icon icon="material-symbols:close-small-outline-rounded" width={42} height={42} />
        </button>
        <button
          className="bg-[#CF0039] text-white rounded-full w-24 h-24 flex items-center justify-center shadow-xl text-4xl select-none"
          tabIndex={-1}
          onClick={handleNavigate}
          aria-label="Navigatie"
        >
          <Icon icon="material-symbols:directions" width={56} height={56} />
        </button>
        <button
          className="bg-[#CF0039] text-white rounded-full w-16 h-16 flex items-center justify-center shadow-lg text-3xl select-none"
          tabIndex={-1}
